<template>
  <view class="container">
    <unicloud-db ref="udb" v-slot:default="{data, loading, error, options}" :options="options" :collection="collectionList" field="user_id,title,content,description,province,excerpt,article_status,last_comment_user_id,picArr,publish_date,last_modify_date,mode" :where="queryWhere" :getone="true" :manual="true">
