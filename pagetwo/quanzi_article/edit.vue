<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="description" label="标题">
        <uni-easyinput placeholder="标题" v-model="formData.description" trim="both"></uni-easyinput>
      </uni-forms-item>
      ...
      <uni-forms-item name="picArr" label="封面大图">
        <uni-data-checkbox :multiple="true" v-model="formData.picArr"></uni-data-checkbox>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("user_id,title,content,description,province,excerpt,article_status,last_comment_user_id,picArr,publish_date,last_modify_date,mode").get().then((res) => {
